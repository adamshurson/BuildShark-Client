    ...
    render() {
        ...
        return this.props.shouldDisplay
                ? <div className="bg-black flex items-center relative shadow-md">
                    <svg onClick={() => this.props.history.push("/")} className="p-2 pl-12 cursor-pointer"
                        viewBox="0 0 100 100"
                        height="60px"
                    ...
                    <div className="ml-auto absolute pin-t pin-b pin-r flex pr-12">
                        ...
                        <button className="header-menu hover:bg-blue h-full flex items-center cursor-pointer relative">
                            ...
                            <div className="z-10 header-submenu pin-b pin-r absolute flex flex-col shadow-md bg-white">
                                ...
                                <h4 onClick={() => this.props.history.push("/company")} className="text-black p-4 hover:bg-orange hover:text-white whitespace-no-wrap text-right">Company</h4>
                                <h4 onClick={() => this.props.logout()} className="text-black p-4 hover:bg-orange hover:text-white whitespace-no-wrap text-right">Logout</h4>
                            </div>
                        </button>
                    </div>
                </div>
